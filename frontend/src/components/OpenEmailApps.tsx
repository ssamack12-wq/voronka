    ...
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="grid grid-cols-2 gap-2">
        {MAIL_APPS.map((app) => (
          <button
            ...
            className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl border border-gray-200 text-xs font-semibold text-graphite hover:border-accent/40 hover:bg-accent-soft/30 transition-colors"
          >
      ...
      {email && (
        <a
          ...
          className="flex items-center justify-center gap-2 w-full py-3 rounded-2xl bg-accent-soft text-accent text-sm font-semibold"
        >
